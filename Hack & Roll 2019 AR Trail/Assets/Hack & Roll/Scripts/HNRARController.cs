...
public class HNRARController : MonoBehaviour
{
  ...
  private bool hasScannedImage = false;

  private bool showScanPromptOnce = false;
  ...
  private void Update()
  {
    ...
    else
    {
      ...
      {
        if (!hasScannedImage & !showScanPromptOnce)
        {
          showScanPromptOnce = true;
      ...
      else
      {
        ...
        //UIController.ShowNavigatingScreen();
